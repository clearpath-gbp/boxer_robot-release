## boxer_robot (noetic) - 0.1.7-1

The packages in the `boxer_robot` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic boxer_robot` on `Tue, 21 Jun 2022 20:23:03 -0000`
